...
<div id="heading" class="text-lg text-center mb-8">Recurring Expenses</div>

{#if expenses.length > 0}
  <div class="table-wrap">
    <table id="recurring-expenses" class="table caption-bottom">
      <thead>
        <tr>
          <th>Id</th>
          <th>Name</th>
...
<div class="flex flex-col gap-4">
  <button id="new" type="button" class="btn preset-outlined-surface-300-700 w-full" onclick={newExpense}>New</button>

  <button id="edit" type="button" class="btn preset-outlined-surface-300-700 w-full" onclick={editExpense}>Edit</button>
</div>
